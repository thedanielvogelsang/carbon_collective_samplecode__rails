class HouseSerializer < ActiveModel::Serializer
  ...
  def total_electricity_consumption_to_date
    object.total_electricity_consumption_to_date
  end
  ...
  def avg_total_electricity_consumption_per_resident
    (object.avg_total_electricity_consumption_per_resident) if object.avg_total_electricity_consumption_per_resident != nil
  end
