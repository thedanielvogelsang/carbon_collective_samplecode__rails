class CountyElectricitySerializer < ActiveModel::Serializer
  ...
  def avg_daily_consumed_per_user
    (object.avg_daily_electricity_consumed_per_user).round(2) if object.avg_daily_electricity_consumed_per_capita != nil
  end
  ...
  def avg_monthly_consumed_per_user
    (object.avg_daily_electricity_consumed_per_user * 29.53).round(2) if object.avg_daily_electricity_consumed_per_capita != nil
  end
