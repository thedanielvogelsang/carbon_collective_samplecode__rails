...
COUNTRIES = {
  ...
  ["Cape Verde (Cabo Verde)", 542, 12772.7162, nil, 0.6769],
  ...
  ["Ivory Coast (Cote d'Ivoire)", 244, 20592.2074, nil, 0.3164],
  ...
  ["Kyrgyz Republic (Kyrgyzstan)", 1920, 525438.108, nil, 1.042],
  ...
  ["Korea, Democratic Republic of (North Korea)", 1347, 78723.256, nil, 3.5098],
  ...
  ["Russian Federation", 7481, 120330.346, nil, 11.1157],
  ...
  ["Slovak Republic (Slovakia)", 5207, 33681.93, nil, 6.5442],
  ...
  ["Korea, Republic of (South Korea)", 9720, 143313.31, nil, 10.8874],
  ...
  ["Virgin Islands (UK)", 2921, nil, nil, 6.0363],
  ["Virgin Islands (US)", 5828, nil, nil, 113.7142],
  ["West Bank", 1927, 27500.3052, nil, 0.7827],
